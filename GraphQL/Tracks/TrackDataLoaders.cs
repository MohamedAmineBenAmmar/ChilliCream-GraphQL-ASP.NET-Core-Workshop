...
public static class TrackDataLoaders
{
     ...
     CancellationToken cancellationToken)
    {
        return await dbContext.Sessions
            ...
            .OrderBy(s => s.Id)
            .ToBatchPageAsync(s => (int)s.TrackId!, pagingArguments, cancellationToken); // Here, we use the ToBatchPageAsync method to return a page of sessions for each track ID.
    }
}